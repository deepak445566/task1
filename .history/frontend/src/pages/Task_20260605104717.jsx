            ...
            <div className="flex flex-col sm:flex-row gap-3 items-center w-full lg:w-auto">
              <div className="flex gap-2 sm:gap-3 justify-center w-full sm:w-auto">
                ...
                <div className="text-center px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 bg-orange-50 rounded-lg sm:rounded-xl">
                  <p className="text-xl sm:text-2xl font-bold text-orange-600">{pendingTasks}</p>
                      ...
                      >
                        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3 sm:gap-4">
                          <div className="flex-1 min-w-0">
                            ...
                            {task.description && (
                              <p className="text-xs sm:text-sm text-gray-500 ml-6 sm:ml-8 mb-1 sm:mb-2 break-words">
                                {task.description}
                              </p>
                            )}
                          </div>

                          <div className="flex gap-1.5 sm:gap-2 ml-6 sm:ml-0">
                            <button
